...
class ColorDetector:
    ...
    def __init__(self, image_path, csv_path="colors.csv"):
        ...
        self.current_red = (
            self.current_green
        ) = self.current_blue = self.xpos = self.ypos = 0
        # Read color data from CSV
        self.csv = pd.read_csv(
            csv_path, names=["color", "color_name", "hex", "R", "G", "B"], header=None
        )
    ...
    def draw_rectangle(self):
        ...
        cv2.rectangle(
            ...
            (20, 20),
            (750, 60),
            (self.current_blue, self.current_green, self.current_red),
            -1,
        )
    ...
    def draw_text(self, text):
        ...
        color = (
            (255, 255, 255)
            if self.current_red + self.current_green + self.current_blue < 600
            else (0, 0, 0)
        )
